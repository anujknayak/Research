...
figure(1);plot([1:numBatches*numSlotsPerBatch], cdfVec, 'r-o', 'linewidth', 2);ylabel('Probability of best strategy selection');xlabel('time-slot');grid on;set(gca, 'fontsize', 15);
...
figure(2);plot([1:numBatches], sum(avgUtilityAll, 1)/numIters, 'b-o');hold on;plot([1:numBatches], max(max(avgUtilityAll))*ones(1,numBatches), 'm', 'linewidth', 2);grid on;set(gca, 'fontsize', 20);xlabel('batch Index');ylabel('Utility');
legend('averge utility','maximum utility');

figure(3);plot([1:numBatches], sum(avgUtilityAll, 1)/numIters, 'b-o');hold on;plot([1:numBatches], max(max(avgUtilityAll))*ones(1,numBatches), 'm', 'linewidth', 2);plot([1:numBatches], max(max(avgUtilityAll))*ones(1,numBatches)-sum(avgUtilityAll, 1)/numIters, 'k-x');grid on;set(gca, 'fontsize', 20);xlabel('batch Index');ylabel('Utility/Regret');
legend('averge utility','maximum utility','weak regret');
